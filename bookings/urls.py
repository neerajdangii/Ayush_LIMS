...
urlpatterns = [
    ...
    path("bulk-delete/", BookingBulkDeleteView.as_view(), name="bulk_delete"),
    ...
    path("billing/undo-history/", BillingUndoHistoryView.as_view(), name="billing_undo_history"),
